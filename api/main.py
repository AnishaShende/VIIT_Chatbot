...
# HuggingFace Authentication (if necessary) C:\Users\Admin\OneDrive\Desktop\VIIT\chatbot\api
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allows all origins, or specify a list of origins e.g. ['http://localhost:5173']
